import { installGrandLineLearningParent } from './grand-line-learning-parent.js?v=3.1.0';
...
export function installGrandLinePortal(env) {
  ...
  function start() {
    ...
    const url=new URL('./grand-line.html',win.location.href);url.searchParams.set('v','3.1.0');url.searchParams.set('subject',subject.toLowerCase());url.searchParams.set('profile',ctx.profileKey);url.searchParams.set('learning','1');
