# Grand Line TCG — lore anchors

Reviewed 15 September 2026. Primary sources: the official ONE PIECE character directory and Bandai Namco official character features. Search-index excerpts were used where the official site rejected direct fetches.

Character identities, fruit families, weapons and fighting themes follow these sources. The 50-card roster, ratings, statistical passives, costs, durations, status translations and some move labels are original fan-game adaptations. Seven-star rarity is an expansion rule, not an official power ranking. All battle revivals mean recovery from a knockout, not reversal of canonical deaths. Campaign enemy lineups are dream-match encounters rather than a retelling of canonical alliances. Admiral Akainu is the requested Marineford-era card title; Sakazuki is currently identified as fleet admiral by his official profile.

| Character | Lore anchor used | Source |
|---|---|---|
| Monkey D. Luffy | Rubber limbs, fearless Haki and a liberating fighting spirit. | [Official source](https://one-piece.com/character/luffy/index.html) |
| Roronoa Zoro | Three blades and an unbending ambition to become the greatest swordsman. | [Official source](https://one-piece.com/character/zoro/index.html) |
| Nami | A master navigator who turns weather science and her Clima-Tact into lightning. | [Official source](https://one-piece.com/character/nami/index.html) |
| Usopp | A sharpshooter whose Pop Greens turn a slingshot into a living arsenal. | [Official source](https://www.bandainamcoent.com/news/one-piece-odyssey-straw-hat-crew) |
| Sanji | A brilliant cook who reserves his hands for food and his burning kicks for battle. | [Official source](https://www.bandainamcoent.com/news/one-piece-odyssey-straw-hat-crew) |
| Tony Tony Chopper | A reindeer doctor whose Human-Human Fruit and Rumble Ball unlock multiple forms. | [Official source](https://www.bandainamcoent.com/news/one-piece-odyssey-straw-hat-crew) |
| Nico Robin | The Flower-Flower Fruit lets Robin sprout limbs and restrain enemies from unexpected angles. | [Official source](https://www.bandainamcoent.com/news/one-piece-odyssey-straw-hat-crew) |
| Franky | Cola-powered cybernetics, built-in weapons and a very super battle machine. | [Official source](https://www.bandainamcoent.com/news/one-piece-odyssey-straw-hat-crew) |
...
| Hatchan | The octopus fish-man fights with six swords and later runs the Takoyaki 8 stand. | [Official source](https://one-piece.com/character/Hacchan/index.html) |
| Crocodile | The Sand-Sand Fruit drains moisture while a hooked weapon delivers venom. | [Official source](https://one-piece.com/character/Crocodile/index.html) |
| Donquixote Doflamingo | Razor-sharp strings bind, cut and reshape the battlefield. | [Official source](https://one-piece.com/character/doflamingo/index.html) |
| Buggy | Chop-Chop separation and outrageous explosives conceal an uncanny talent for survival. | [Official source](https://one-piece.com/character/Buggy/index.html) |
| Smoker | Billowing smoke and a seastone-tipped jitte trap fleeing pirates. | [Official source](https://one-piece.com/character/smoker/index.html) |
| Tashigi | A principled Marine swordswoman who studies celebrated blades. | [Official source](https://one-piece.com/character/tashigi/index.html) |
| Koby | Training under Garp and awakened Observation Haki turn courage into strength. | [Official source](https://one-piece.com/character/Coby/index.html) |
| Don Krieg | The East Blue fleet captain carries many concealed weapons; armor, explosives and poison gas define his arsenal. | [Official source](https://one-piece.com/character/Don_Krieg/index.html) |
| Paulie | A Galley-La shipwright and rigging specialist who uses ropes to bind enemies and rescue allies. | [Official source](https://one-piece.com/character/Paulie/index.html) |
| Hina | The Black Cage Marine’s Bind-Bind Fruit lets her pass through opponents and restrain them with iron. | [Official source](https://one-piece.com/character/Hina/index.html) |
| Kuzan | The Ice-Ice Fruit freezes seas and traps enemies in deep cold. | [Official source](https://one-piece.com/character/kuzan/index.html) |
| Admiral Fujitora | A blind swordsman whose gravity power can press foes down and summon falling debris. | [Official source](https://one-piece.com/character/fujitora/index.html) |
| Admiral Ryokugyu | The Woods-Woods Fruit grows roots and a towering forest body. | [Official source](https://one-piece.com/character/Aramaki/index.html) |
| Kaku | The giraffe Zoan agent combines two swords and Tempest Kicks into four-sword fighting. | [Official source](https://one-piece.com/character/Kaku/index.html) |
| Wapol | The Munch-Munch Fruit lets the former Drum king incorporate what he eats and combine it through his factory ability. | [Official source](https://one-piece.com/character/Wapol/index.html) |
...
| Rob Lucci | A leopard Zoan and the Six Powers produce precise, devastating martial arts. | [Official source](https://one-piece.com/character/Rob_Lucci/index.html) |
| Perona | Hollow-Hollow ghosts sap the enemy’s confidence and explode on command. | [Official source](https://one-piece.com/character/Perona/index.html) |
| Bartolomeo | Crossed fingers create near-impenetrable barriers to protect his idols. | [Official source](https://one-piece.com/character/bartolomeo/index.html) |
| Bentham · Bon Clay | Clone-Clone disguise, ballet-like kicks and loyalty that never retreats. | [Official source](https://one-piece.com/character/Bon_Clay_Mr2/index.html) |
| Carrot | Mink agility and Electro become dazzling speed beneath the full moon. | [Official source](https://one-piece.com/character/carrot/index.html) |
| Nefertari Vivi | A brave princess whose peacock slashers and leadership keep her friends together. | [Official source](https://one-piece.com/character/Nefeltari_Vivi/index.html) |
| Arlong | A sawshark fish-man attacks with his saw-shaped nose, powerful jaws and Kiribachi blade. | [Official source](https://one-piece.com/character/Arlong/index.html) |
| Magellan | The Venom-Venom Fruit creates toxic creatures and overwhelming clouds of poison. | [Official source](https://one-piece.com/character/Magellan/index.html) |
| Kaido the Beast | A legendary dragon form and thunderous kanabo embody overwhelming force. | [Official source](https://one-piece.com/character/Kaido/index.html) |
